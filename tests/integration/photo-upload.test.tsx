...
describe('photo upload integration', () => {
  it('uploads a valid file, shows progress, and renders the success state', async () => {
    ...
    act(() => {
      xhr?.succeed({ uploadedPhotoUrl: 'https://cdn.example.com/portrait.jpg' });
    });

    expect(container.textContent).toContain('Upload complete.');
    expect(container.innerHTML).toContain('https://cdn.example.com/portrait.jpg');
