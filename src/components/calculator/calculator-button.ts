...
const baseButtonClasses = [
  'relative inline-flex min-h-14 w-full select-none items-center justify-center overflow-hidden rounded-2xl',
  'border text-lg font-semibold tabular-nums shadow-lg backdrop-blur-xl',
  'transition-colors duration-150 active:shadow-md sm:min-h-16 sm:text-xl',
  'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400',
  'focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950/10',
...
export const calculatorButtonVariantClasses: Record<CalculatorButtonVariant, string> = Object.freeze({
  digit: [
    'border-white/35 bg-white/65 text-slate-950 shadow-slate-900/10',
    'hover:bg-white/85 dark:border-white/10 dark:bg-slate-800/70 dark:text-slate-50',
    'dark:shadow-black/25 dark:hover:bg-slate-700/80',
  ].join(' '),
  decimal: [
    'border-sky-200/70 bg-sky-50/80 text-sky-950 shadow-sky-900/10',
    'hover:bg-sky-100/90 dark:border-sky-300/15 dark:bg-sky-950/55',
    'dark:text-sky-100 dark:shadow-black/25 dark:hover:bg-sky-900/70',
  ].join(' '),
  operator: [
    'border-amber-200/70 bg-amber-100/85 text-amber-950 shadow-amber-900/10',
    'hover:bg-amber-200/85 dark:border-amber-300/15 dark:bg-amber-500/20',
    'dark:text-amber-100 dark:shadow-black/25 dark:hover:bg-amber-500/30',
  ].join(' '),
  clear: [
    'border-rose-200/70 bg-rose-100/85 text-rose-950 shadow-rose-900/10',
    'hover:bg-rose-200/90 dark:border-rose-300/15 dark:bg-rose-500/20',
    'dark:text-rose-100 dark:shadow-black/25 dark:hover:bg-rose-500/30',
  ].join(' '),
  equals: [
    'border-indigo-300/70 bg-indigo-600 text-white shadow-indigo-900/25',
    'hover:bg-indigo-500 dark:border-indigo-300/30 dark:bg-indigo-400',
    'dark:text-slate-950 dark:shadow-indigo-950/30 dark:hover:bg-indigo-300',
  ].join(' '),
});
