...
export const calculatorThemeToggleClasses = Object.freeze({
  root: [
    'inline-flex items-center gap-1 rounded-full border border-white/30',
    'bg-white/45 p-1 text-slate-700 shadow-lg shadow-slate-900/10 backdrop-blur-xl',
    'transition-colors duration-200',
    'dark:border-white/10 dark:bg-slate-950/45 dark:text-slate-100 dark:shadow-black/25',
  ].join(' '),
  option: [
  ...
  optionInactive: 'text-slate-600 dark:text-slate-300',
  icon: 'text-base leading-none',
  label: 'sr-only sm:not-sr-only sm:ml-2',
  mountedPlaceholder: 'h-9 min-w-[5.5rem] rounded-full bg-white/35 dark:bg-white/10',
});
