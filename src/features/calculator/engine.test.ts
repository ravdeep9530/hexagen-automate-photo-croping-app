...
describe('calculatorReducer state transitions', () => {
  ...
  it('does not restore malformed history entries', () => {
    ...
    const malformedEntries: unknown[] = [
      null,
      '10 + 5 = 15',
      { expression: '10 + 5 =', result: '15', createdAt: '2023-11-14T22:13:20.000Z' },
      { id: '', expression: '10 + 5 =', result: '15', createdAt: '2023-11-14T22:13:20.000Z' },
      { id: 'history-1', expression: '', result: '15', createdAt: '2023-11-14T22:13:20.000Z' },
      { id: 'history-1', expression: '10 + 5 =', result: '', createdAt: '2023-11-14T22:13:20.000Z' },
      { id: 'history-1', expression: '10 + 5 =', result: '15', createdAt: Number.NaN },
      { id: 'history-1', expression: '10 + 5 =', result: '15', createdAt: '2023-11-14' },
    ];
