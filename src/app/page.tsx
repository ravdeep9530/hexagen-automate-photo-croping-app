  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col gap-6 px-6 py-10">
      <div className="space-y-2">
        ...
        <p className="text-sm text-slate-600">Track the upload and crop pipeline for a photo session.</p>
      </div>
      ...
      <section aria-live="polite" className="rounded-lg border border-slate-200 p-4">
        ...
        <div className="mt-4 space-y-3 text-sm">
          <div>
            ...
            {uploadedPhotoUrl ? (
              <a className="text-blue-600 underline" href={uploadedPhotoUrl}>
                {uploadedPhotoUrl}
              </a>
            ) : (
          ...
          <div>
            ...
            {croppedPhotoUrl ? (
              <a className="text-blue-600 underline" href={croppedPhotoUrl}>
                {croppedPhotoUrl}
              </a>
            ) : (
              <p className="text-slate-500">Not available yet</p>
